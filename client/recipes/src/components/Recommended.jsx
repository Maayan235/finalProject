...
// needs to be changes to recommended instead of populr!!!
    ...
    const getPopular = async () => {
        ...
        //if(check){
            ...
            // const apii = await fetch(`https://api.spoonacular.com/recipes/random?apiKey=${process.env.REACT_APP_API_KEY}&number=500`);
            ...
            //   (recipe) =>
            //     recipe.types.includes("japanese") || recipe.types.includes("thai")
            // );
            // console.log("added:")
